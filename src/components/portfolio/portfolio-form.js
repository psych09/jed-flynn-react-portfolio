...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://jedflynn.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        }
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://jedflynn.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
    ...
    handleSubmit(event) {
        ...
        .then(res => {
            ...
            this.setState({
                ...
                logo: "",
                editMode: false,
                apiUrl: `https://jedflynn.devcamp.space/portfolio/portfolio_items/${this.state.id}`,
                apiAction: "patch"
            });
